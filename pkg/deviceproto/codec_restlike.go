...
const (
	...
	StatusCode_TooManyObservers    StatusCode = 9
)
...
func (c StatusCode) String() string {
	...
	case StatusCode_TooManyRequests:
		return "StatusCode_TooManyRequests"
	case StatusCode_TooManyObservers:
		return "StatusCode_TooManyObservers"
	default:
	}
